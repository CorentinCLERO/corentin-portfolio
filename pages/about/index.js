            ...
            <div className="flex flex-1 xl:gap-x-6">
              <div>
                <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
                  ...
                  <div className="text-xs uppercase trcking-[1px] leading-[1.4] max-w-[100px]">Years of experience</div>
                </div>
              </div>
              <div>
                <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
                  ...
                  <div className="text-xs uppercase trcking-[1px] leading-[1.4] max-w-[100px]">Satisfied clients</div>
                </div>
              </div>
              <div>
                <div className="relative flex-1">
                  ...
                  <div className="text-xs uppercase trcking-[1px] leading-[1.4] max-w-[100px]">Finished projects</div>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="flex gap-x-4 xl:gap-x-8 mx-auto xl:mx-0 mb-4">
            {aboutData.map((item, itemIndex) => {
              return (
                <div
                  key={itemIndex}
                  className={`${index === itemIndex && 'text-accent after:w-[100%] after:bg-accent after:transition-all after:duration-300'} cursor-pointer capitalize xl:text-lg relative after:w-8 after:h-[2px] ${index !== itemIndex && 'after:bg-white'} after:absolute after:-bottom-1 after:left-0`}
